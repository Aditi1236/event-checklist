        ...
        <div
         ...
         >
          <div
            ...
            style={{
              background: "linear-gradient(90deg, transparent, rgba(16,185,129,0.55), rgba(124,58,237,0.4), transparent)",
            }}
          />
          ...
          <div className="p-8">
            ...
            {!isForgotPassword && (
              <div className="mt-6 text-center text-sm font-medium" style={{ color: "#64748b" }}>
